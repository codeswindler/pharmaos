...
export default function AdminDashboard() {
  ...
  const cards = [
    { label: "Total Hospitals", value: stats?.total ?? 0, icon: Building2, color: "#00c46a", bg: "rgba(0,196,106,0.1)", border: "rgba(0,196,106,0.2)" },
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-white/45 text-sm mt-1">Manage hospitals, subscriptions, and system health</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <Link href="/admin/hospitals/new">
            <div className="p-4 rounded-xl cursor-pointer transition-all hover:bg-white/5 group"
              ...
              <p className="text-sm font-semibold text-white">Onboard Hospital</p>
              <p className="text-xs text-white/40 mt-1">Create a new hospital account and set subscription plan</p>
            </div>
          </Link>
          <Link href="/admin/hospitals">
            <div className="p-4 rounded-xl cursor-pointer transition-all hover:bg-white/5 group"
              ...
              <p className="text-xs text-white/40 mt-1">View, edit, or suspend hospital accounts</p>
            </div>
          </Link>
